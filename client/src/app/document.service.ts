...
export class DocumentService {
  ...
  // Gets a list of available documents from the Java application server. In
  // this sample, the Java application server just returns a simple list of
  ...
  // Asks the Java application server to create a viewing session for a
